...
while($row = mysqli_fetch_assoc($result_query)){
  ...
  <div class='card'>
               ...
               <p class='card-text'>price: $product_price/-</p>
               <a href='index.php?add_to_cart=$product_id 'class='btn btn-info'>Add To Cart</a>
               <a href='#'class='btn btn-secon    dary'>View More</a>
               </div>
   </div>
 </div>";
}
...
$select_query = "Select * from `cart_detailes` where ip_address='$get_ip_add' and 
...
echo "<script>window.open('index.php',_self')</script>";
  ...
  $insset_query = "insert into `cart_detailes`(product_id,ip_address,
  quantity) value($get_product_id,'$get_ip_add',0)";
  $result_query = mysqli_query($con,$insset_query);
...
if(isset($_GET['add_to_cart'])){
  ...
  $select_query = "Select * from `cart_detailes` where ip_address='$get_ip_add'";
  $result_query = mysqli_query($con,$select_query);
